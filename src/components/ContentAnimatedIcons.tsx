...
import { 
  Mic, FileText, Package, Search, Brain, Settings, 
  CalendarDays, Users, Clock, Shield, BarChart3, 
  Database, Monitor, Smartphone, Headphones, Cloud,
  Target, Layers3, MessageCircle, CheckCircle2, ArrowRight,
  Cog, Wrench, AlertTriangle, TrendingUp, Gauge,
  Phone, Mail, MapPin, Building2, Zap, Activity
} from 'lucide-react';
...
export const AnimatedContentIcon: FC<AnimatedContentIconProps> = ({ 
  ...
  return (
    <div 
      className={`animated-content-icon animated-content-${type} ${className}`}
